...
<head>
    ...
    <title>iSkolar Online - Generate Report</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseGenerateReport" class="collapse" aria-labelledby="headingGenerateReport" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="generateReport.php">Current Scholarship list</a>
    ...
    Scholarship Programs
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Generate Report Current Scholar List</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
...
<div class="advanced-search" id="advanced-search-form" style="display: none; margin-top: 20px;">
    ...
    <!-- <div class="form-group">
        ...
        <select id="schoolYear" name="schoolYear" class="custom-select">
            ...
            <option value="MERIT">2021-2022</option>
            <option value="MERIT">2022-2023</option>
            <option value="NEED">2023-2024</option>
        </select>
    </div> -->
    <div class="form-group">
