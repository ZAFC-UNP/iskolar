...
<head>
    ...
    <title>iSkolar Online - Create Announcement</title>
...
.custom-select option.text-danger {
    color: #dc3545;
}
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseAnnouncements" class="collapse" aria-labelledby="headingAnnouncements" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="#">Create Announcement</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                         ...
                         <div class="col-xl-12 mb-4">
                            ...
                            <h6 class="m-0 font-weight-bold ">Content of Announcement</h6>    
                        </div>
                                <div class="card-body">
                                <form id="announcementForm" action="controller/create_announcement.php" method="post" enctype="multipart/form-data">
                ...
                <select id="recipient" name="recipient" class="custom-select"> 
                    ...
                    ?>
                                    ...
                                    <div class="form-group-centered">
                                        <img id="photoPreview" src="uploads/announcement/newUnpSeal.png" alt="Image Preview" style="max-width: 300px; height: auto;">
                                    </div>
                                    <div class="form-group">
                                        <label for="photo">Upload Photo:</label>
                                        <input type="file" id="photo" name="photo" accept="image/*" class="form-control" onchange="previewImage()">
                                    </div>
                                    <button type="submit" class="btn-success rounded" style="float: right;">📢 Create Announcement</button>
                                </form>
                                <script>
    document.getElementById('announcementForm').addEventListener('submit', function(event) {
        ...
        fetch('controller/create_announcement.php', {
            method: 'POST',
            body: formData
        })
        ...
        .catch(error => {
            ...
            Swal.fire('Error!', 'An error occurred while creating the announcement.', 'error');
        });
    });
    ...
    function previewImage() {
        ...
        if (file) {
            ...
            document.getElementById('photoPreview').src = 'uploads/announcement/newUnpSeal.png'; // Reset to default image
        }
    }
</script>   
...
function previewImage() {
    ...
    if (file) {
        ...
        preview.src = 'uploads/announcement/newUnpSeal.png';
    }
}
</script>
