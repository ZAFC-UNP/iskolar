...
<head>
    ...
    <title>Iskolar Online - Add User</title>
    ...
    Scholarship Programs
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add User Account</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                         ...
                         <div class="col-xl-12 mb-4">
                            ...
                            <div class="card-header py-2"> Create User <span><a href="addedUsers.php" style="float: right;">Manage Added Users</a></span></div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="imgcontainer">
                                            <div class="avatar-preview">
                                                <img src="img/undraw_profile.svg" alt="Avatar Preview" id="avatar-preview">
                                            </div>  
                                        </div>
                                        <div class="imgcontainer" >
                                            <div class="avatar-preview">
                                                <img src="img/undraw_profile.svg" alt="Avatar Preview" id="avatar-previewSml" style="height:100px; width: 100px; margin-left: 20px; margin-top: 100px;">
                                            </div>  
                                        </div>
                                        <div class="imgcontainer" >
                                            <div class="avatar-preview">
                                                <img src="img/undraw_profile.svg" alt="Avatar Preview" id="avatar-previewXSml" style="height:50px; width: 50px; margin-left: 20px; margin-top: 150px;">
                                            </div>  
                                        </div>
                                    </div>
                                    <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="avatar" name="avatar" accept="image/*" onchange="previewAvatar(event)" style="cursor: pointer;">
                                    ...
                                    <button type="submit" class="btn-primary rounded"  style="float: right;">Add User</button>
                                    </form>
...
<script>
    ...
    reader.onload = function() {
        ...
        const imgElements = document.getElementById('avatar-previewSml');
        const imgElementxs = document.getElementById('avatar-previewXSml');
        imgElement.src = reader.result;
        imgElements.src = reader.result;
        imgElementxs.src = reader.result;
    }
